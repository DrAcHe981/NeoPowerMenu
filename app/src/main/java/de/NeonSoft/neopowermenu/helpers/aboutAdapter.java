...
public class aboutAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int p1, View p2, ViewGroup p3) {
        ...
        } else if (this.itemsTexts.get(p1).contains("Click here to reset the settings.")) {
            Text.setOnClickListener(new OnClickListener() {
                            ...
                            dialogFragment.setListener(new slideDownDialogFragment.slideDownDialogInterface() {
                                ...
                                public void onPositiveClick(Bundle resultBundle) {
                                    ...
                                    if (position == 0) {
                                        ...
                                        MainActivity.colorPrefs.edit().clear().apply();
                                        MainActivity.orderPrefs.edit().clear().apply();
                                        MainActivity.animationPrefs.edit().clear().apply();
